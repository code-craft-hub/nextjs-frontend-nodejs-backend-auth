    ...
    <div className="w-full" {...getRootProps()}>
      <motion.div
        ...
        className={cn(
          ...
          files.length === 0 &&
            "border-dashed border-2 border-blue-500  overflow-hidden "
        )}
      >
        <input
          title="file upload"
          ...
          <div className="relative w-full mx-auto">
            ...
            {!files.length && (
              ...
              // @ts-ignore
                ...
                className={cn(
                  "relative group-hover/file:shadow-2xl z-40  dark:bg-neutral-900 flex flex-col items-center justify-center h-32  w-full  mx-auto rounded-md",
                  "hover:shadow-[0px_10px_50px_rgba(0,0,0,0.1)]"
                )}
              >
                {isDragActive ? (
                  <motion.p
