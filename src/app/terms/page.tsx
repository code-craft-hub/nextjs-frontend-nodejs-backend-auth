  ...
  return (
    <div>
      ...
      <div className="flex flex-col p-4 md:p-8 gap-4 md:gap-8 items-center justify-center max-w-screen-md mx-auto text-start">
        <h1 className="font-bold text-2xl ">TERMS OF USE FOR CVER JOB APPLICATIONS LTD</h1>
        <p className="text-start w-full">
          <span className="font-bold text-xl">
            Thank you for using Cver Job Applications LTD!
          </span>
          <br /> <br /> These Terms of Use apply to your use of Cver Job Applications LTD, and
          Cver Job Applications LTD other services for individuals, along with any associated
          software applications and websites (all together, “Services”). These
          Terms form an agreement between you and Cver Job Applications LTD, a limited company
        ...
        <p className="text-start w-full">
          Our Business Terms govern use of Cver Job Applications LTD, our APIs, and our other
        ...
        <p className="text-start w-full">
          ...
          <br />
          Cver Job Applications LTD is a SAAS Product that tailors your resume to every single job
          application. For more information about Cver Job Applications LTD, please visit
          https://cverai.com
        </p>
        <p className="text-start w-full">
        ...
        <p className="text-start w-full">
          ...
          <br />
          7. Use Output to develop models that compete with Cver Job Applications LTD.
        </p>
        <p className="text-start w-full">
        ...
        <p className="text-start w-full">
          ...
          <br />
          As between you and Cver Job Applications LTD, and to the extent permitted by
          applicable law, you (a) retain your ownership rights in Input and (b)
          own the Output. We hereby assign to you all our right, title, and
        ...
        <p className="text-start w-full">
          ...
          this right of cancellation, you must notify Cver Job Applications LTD of your decision
          within the 14-day period. Upon receipt of your cancellation
          request—and provided that the Services have not been substantially
          used or accessed beyond any trial period—you will be entitled to a
          full refund of all payments made in connection with the transaction.
          The refund will be processed using the same payment method employed
          for the original transaction, and no cancellation fees will be
          incurred. For subscription-based Services, this right to cancel
          applies solely to the initial purchase and does not extend to any
          subsequent automatic renewals. Please note that once the Services have
          been fully delivered, downloaded, or otherwise accessed in a manner
          that precludes a meaningful cancellation, your right to a refund may
          be limited or excluded in accordance with applicable law. By
          completing a transaction with Cver Job Applications LTD, you acknowledge and agree to
          the terms of this Refund Policy.
        </p>
        <p className="text-start w-full">
          ...
          <br />
          3. Your use of our Services could cause risk or harm to Cver Job Applications LTD,
        ...
        <p className="text-start w-full">
          ...
          laws of the jurisdiction in which Cver Job Applications LTD is based, without giving
          effect to any principles of conflicts of law. Any disputes arising out
          of or related to these TOU or our service shall be resolved through
          binding arbitration in accordance with the rules of the relevant
          arbitration association. If arbitration is not permitted by law, then
          the parties agree to resolve any disputes in the courts of the
          jurisdiction in which Cver Job Applications LTD is based.
        </p>
        <p className="text-start w-full">
        ...
        <p className="text-start w-full">
          ...
          extent permissible by applicable law, Cver Job Applications LTD disclaims all
          warranties, express or implied, including, but not limited to, implied
          warranties of merchantability and fitness for a particular purpose. In
          no event shall Cver Job Applications LTD be liable for any damages (including,
          ...
          Service, even if Cver Job Applications LTD or a Cver Job Applications LTD authorized representative
        ...
        <p className="text-start w-full">
          ...
          otherwise mislead Cver Job Applications LTD or third parties as to the origin of any
          Comments. You are solely responsible for any Comments you make and
          their accuracy. Cver Job Applications LTD takes no responsibility and assumes no
        ...
        <p className="text-start w-full">
          ...
          are not owned or controlled by Cver Job Applications LTD. Cver Job Applications LTD has no control
          ...
          acknowledge and agree that Cver Job Applications LTD shall not be responsible or
          liable, directly or indirectly, for any damage or loss caused or
          alleged to be caused by or in connection with the use
        </p>
        <p className="text-start w-full">
          ...
          you and Cver Job Applications LTD with respect to your use of our service. If any
          provision of these TOU is found to be invalid or unenforceable, the
          remaining provisions shall remain in full force and effect. By using
          our service, you acknowledge that you have read, understood, and agree
          to be bound by these TOU. If you do not agree to these TOU, you should
          not use our service.
        </p>
        <p className="text-start w-full">
        ...
        <p className="text-start w-full">
          <span className="font-bold text-xl">Cver Job Applications LTD</span> <br />
          <br />
        ...
        <p className="text-start w-full">
          ...
          <br />
          These Terms contain the entire agreement between you and Cver Job Applications LTD
