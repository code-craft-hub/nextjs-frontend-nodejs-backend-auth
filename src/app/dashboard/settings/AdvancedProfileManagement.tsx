...
const configurationData: ConfigurationItem[] = [
  ...
  },
  {
    ...
    description:
      "AI automatically provides best effort answers for uncommon questions",
    defaultChecked: false,
  },
];
  ...
  return (
    <div className="flex items-center justify-between w-full">
      <div className="flex-1">
        <h3 className="text-md font-medium text-gray-900 mb-1">{item.title}</h3>
...
export const AdvancedProfileManagement: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-start font-inter gap-5">
