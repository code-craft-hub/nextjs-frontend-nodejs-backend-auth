...
function CveraiChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "border-border/50 bg-white grid min-w-[8rem] font-inter items-start gap-1.5 rounded-lg border px-4 py-1.5 text-xs shadow-xl",
        className
      )}
    >
      {!nestLabel ? tooltipLabel : null}
            ...
            >
              {formatter && item?.value !== undefined && item.name ? (
                ...
                <>
                  ...
                  <div
                    className={cn(
                      "flex flex-1 gap-1 items-center leading-none"
                      // nestLabel ? "items-end" : "items-center"
                    )}
                    style={
                      {
                  ...
                  >
                    {item.value && (
                      <span
                        className={cn("font-inter font-medium tabular-nums")}
