import { formatFirestoreRelative } from "@/lib/utils";
import { ChevronLeft } from "lucide-react";
import { Link, useLocation, useNavigate } from "react-router-dom";
import Header from "./homeComponents/Header";
import Footer from "./homeComponents/Footer";
import { Article } from "@/types";
import { getBlogPostWithRelatedQuery } from "@/lib/react-query/queries";
  ...
  return (
    <section>
      ...
      <section className="max-w-screen-md mx-auto px-4 sm:px-8 space-y-4 pb-16">
        <Link to="/blog" className="flex items-center text-xs text-blue-500">
