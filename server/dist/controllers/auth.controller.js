    ...
    constructor() {
        ...
        this.register = async (req, res) => {
            try {
                ...
                res.status(201).json((0, response_1.createApiResponse)(true, {
                    user: {
                        uid: result.user.uid,
        ...
        this.refreshToken = async (req, res) => {
            try {
                ...
                res.status(200).json((0, response_1.createApiResponse)(true, { tokens }));
            }
            catch (error) {
        ...
        this.requestPasswordReset = async (req, res) => {
            try {
                ...
                logger_1.logger.error('Password reset controller error:', error);
                res.status(200).json((0, response_1.createApiResponse)(true, {
                    message: 'If the email exists, a password reset link has been sent'
                }));
            }
        ...
        this.getSessions = async (req, res) => {
            try {
                ...
                logger_1.logger.error('Get sessions controller error:', error);
                res.status(500).json((0, response_1.createApiResponse)(false, null, {
        ...
        this.revokeSession = async (req, res) => {
            try {
                ...
                logger_1.logger.error('Revoke session controller error:', error);
                res.status(400).json((0, response_1.createApiResponse)(false, null, {
        ...
        this.logoutAllSessions = async (req, res) => {
            try {
                if (!req.user) {
                    res.status(401).json((0, response_1.createApiResponse)(false, null, {
                        code: 'UNAUTHORIZED',
                ...
                logger_1.logger.error('Logout all sessions controller error:', error);
                res.status(500).json((0, response_1.createApiResponse)(false, null, {
...
AuthController.registerValidation = [
    ...
    (0, express_validator_1.body)('displayName').optional().isLength({ min: 1, max: 50 }).trim(),
