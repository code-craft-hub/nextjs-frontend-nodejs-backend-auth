...
export const UserProfileForm: React.FC = () => {
  ...
  return (
    <div 
      className="flex flex-col items-start p-10 gap-2.5 bg-white rounded-lg"
    >
      <div className="flex flex-col items-center gap-11 w-full h-full">
        {/* Header with profile info */}
        <div className="flex flex-col sm:flex-row justify-between items-center w-full">
          <div className="flex flex-row items-center gap-4">
            <div className="w-[86.58px] h-[86.57px] rounded-full overflow-hidden bg-gray-200">
              <img 
                src="/tobi.png" 
                alt="Profile" 
        ...
        {/* Form */}
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col items-start gap-5 w-full">
            {/* First row */}
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      <FormControl>
                        <SelectTrigger className="box-border flex flex-row justify-between items-center w-full h-11 px-3.5 py-2.5 bg-[#F9FAFB] border border-[#D0D5DD] rounded-lg text-xs leading-6">
                          <SelectValue placeholder="Select country" className="text-[#667085]" />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col items-start gap-1.5 w-full">
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      <FormControl>
                        <SelectTrigger className="box-border flex flex-row justify-between items-center w-full h-11 px-3.5 py-2.5 bg-[#F9FAFB] border border-[#D0D5DD] rounded-lg text-xs leading-6">
                          <SelectValue placeholder="Select state" className="text-[#667085]" />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                        {states.map((state) => (
